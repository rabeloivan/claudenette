...
def run_C01_ex01(student_file):
    ...
    for i, (initial_val, expected) in enumerate(test_cases, 1):
        ...
        desc = f"ft_ultimate_ft(nbr={initial_val})"
    ...
    print_exercise_result("ex01/ft_ultimate_ft.c", passed_count, total_count)
