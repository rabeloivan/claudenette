...
def run_C02_ex04(student_file):
    ...
    for i, s in enumerate(test_cases, 1):
        expected = expected_is_lowercase(s)
        actual, err, code = run_test_case(exe_path, input_data=s)
        desc = f"ft_str_is_lowercase(str={display_str(s)})"
    ...
    print_exercise_result("ex04/ft_str_is_lowercase.c", passed_count, total_count)
