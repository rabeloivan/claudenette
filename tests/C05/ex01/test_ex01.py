...
def run_C05_ex01(student_file):
    ...
    for i, nb in enumerate(test_cases, 1):
        ...
        desc = f"ft_recursive_factorial(nb={nb})"
    ...
    print_exercise_result("ex01/ft_recursive_factorial.c", passed_count, total_count)
