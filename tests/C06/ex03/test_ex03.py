...
def run_C06_ex03(student_file):
    exe_path = "./sort_params"
    ...
    for i, params in enumerate(test_cases, 1):
        ...
        desc = f"ft_sort_params(argv={args_desc(params)})"
    ...
    print_exercise_result("ex03/ft_sort_params.c", passed_count, total_count)
