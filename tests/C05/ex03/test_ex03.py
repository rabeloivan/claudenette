...
def run_C05_ex03(student_file):
    ...
    for i, (nb, power) in enumerate(test_cases, 1):
        ...
        desc = f"ft_recursive_power(nb={nb}, power={power})"
    ...
    print_exercise_result("ex03/ft_recursive_power.c", passed_count, total_count)
